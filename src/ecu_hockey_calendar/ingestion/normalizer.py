...
_TEAM_NAME_MAP: dict[str, str] = {
    ...
    "unc charlotte 49ers": "UNC Charlotte",
    ...
    "unc-greensboro": "UNC Greensboro",
    "uncg": "UNC Greensboro",
    "university of north carolina-greensboro": "UNC Greensboro",
    "university of north carolina greensboro": "UNC Greensboro",
    ...
    "north carolina state": "NC State University",
    "north carolina state university": "NC State University",
    "nc state icepack": "NC State University",
